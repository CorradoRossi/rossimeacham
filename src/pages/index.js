...
import avatarImage from './../../static/images/headshot.jpg';
      ...
      <section className="blog container">
        <div className="medium-8 medium-offset-2 large-10 large-offset-1">
          <div className="blog-header">
            ...
            <h1>Rossi Meacham</h1>
            <p>
              I'm Rossi Meacham, a web developer, crypto lover, and
              enthusiastic doer of things. My mission is to write clean and efficient code,
              to solve problems on the web and to keep learning until I stop breathing.
            </p>
          </div>
