          ...
          <header className="header">
            <div className="row text-center">
              <img
                ...
                alt="Kostas Bariotis"
              />
              <h1>In need of a Web Developer? <br/>Search no more.</h1>
            </div>
          </header>
          <Separator />
          <main role="main">
            <p>
              I am a web developer with about five years of experience in
            ...
            <p>
              ...
              <a href="https://www.linkedin.com/in/rossimeacham">LinkedIn profile</a>,
              my <a href="https://github.com/corradorossi">GitHub profile</a> or{' '}
              <a href="mailto:rossimeacham@gmail.com?subject=Freelance%20Javascript%20development">contact me directly</a>. I like receiving email from people.
            </p>
            <p>
              <b>I am currently available to hire for a limited amount of work per week.</b>
            </p>
            <p>
              <a href="mailto:rossimeacham@gmail.com?subject=Freelance%20Javascript%20development">Email me</a>{' '}
